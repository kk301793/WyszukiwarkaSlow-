...
PETLA:
	...
	cld								; ustawienie kierunku szukania do przodu 
	...
	jmp		BRAK					; jesli nieznaleziono to skacz do BRAk
JEST:
	inc		eax						;zwieksz ilosc znaleziono o 1
BRAK:
	cmp 		ebx, edx			; porownaj czy osiagnieto koniec szukania w linii
	jb		PETLA					;jump if Below (skocz do PETLI jesli nie koniec linii)

	ret								;zwracamy wartosc z akumulatora czyli EAX
AsmStart endp
